...
|---|---|---|
| **gematría decimal-posicional 27/28** (1–9, 10–90, 100–900) | griego (*isopsephy*, 27 letras), árabe (*abjad*, 28) | misma asignación posicional que el hebreo (§2) — **parentesco genealógico, no invención independiente** |
...
Esta rejilla 3×3 **es** la estructura 9 = 9+9+9 de §2. Sin la gematría decimal-posicional no hay Aiq Bekar, y sin Aiq Bekar no hay sigilo: la reducción es el **puente §2 ↔ tradición operativa de los sigilos**. **Caveat de datación:** la *reducción* Aiq Bekar es medieval (atestiguada en Midrash Tannaim, Abulafia y Baal ha-Turim; raíz griega *pythmen*), pero el *nombre* «Aiq Bekar», la tabla 3×3 y, sobre todo, el *método del sigilo trazado sobre el kamea* son renacentistas (primero Agrippa, *De occulta philosophia* III, 1531), no judíos medievales; el vínculo Aiq Bekar↔Lo Shu es moderno (Golden Dawn, s.XIX).
...
## 15c. Apocalipsis: el cielo como pergamino sellado
...
### 15c.8 Sefer Raziel HaMalakh — «calcula para ver las generaciones» (verificado, mock de 2026-08-08)

Un texto hermano mayor enmarca exactamente lo que este estudio operacionaliza: **calcular los planetas y los signos del zodíaco en su orden fijo, y así leer las generaciones de principio a fin**. Del *Sefer Raziel HaMalakh* en español (p. 144 del PDF fuente), un pasaje que se lee como la especificación del Lector Caeli:

> «Combina los signos y la rueda. Graba y calcula y asigna y numera. Considera los cálculos de los planetas y los signos del zodíaco. Calcula los períodos y dando vueltas los planetas. De aquellos suspendidos y los signos del zodíaco en el orden perpetuo, ve con la luz. Calcula en orden para ver las generaciones. Prepara para verlos desde el principio hasta el final.
>
> Está escrito, quien actúa y crea, proclama las generaciones desde el principio, antes de la creación del universo. Para comprender las acciones de cada hombre en la rectitud y la maldad, decreta sobre cada uno. De acuerdo a las obras, prepara las obras entre el bien y el mal.»

El «144» que el ojo lee como *ve144 con la luz* es el número de página que el extractor de texto fundió con «ve con la luz» — un hecho textual real del documento (el pasaje está en la p. 144), y 144 = 12² = el muro de la Nueva Jerusalén (Ap 21:17) / los 144.000 sellados (Ap 7:4) de §15c.4. La convergencia es exacta: la página que dice «ve, con la luz» es la página cuyo número es el cuadrado del zodiaco.

**Verificado el 2026-08-08 (mock de hoy).** Cada línea de la instrucción de Raziel, mapeada a lo que el aparato realmente calcula — en vivo, no aseverado:

| Instrucción de Raziel | Calculado el 2026-08-08 |
|---|---|
| «Calcula los períodos y dando vueltas los planetas» | 10 cuerpos, longitud eclíptica → signo: Saturno 14,6°→Aries · Júpiter 128,6°→Leo · Marte 88,1°→Géminis · Sol 136,0°→Leo · Venus 181,7°→Libra · Mercurio 118,2°→Cáncer · Luna 77,9°→Géminis · Urano 65,2°→Géminis · Neptuno 4,2°→Aries · Plutón 304,0°→Acuario. |
| «los signos del zodíaco en el orden perpetuo» | 12 signos × 30°, orden fijo. Hoy 6 ocupados: **Aries, Géminis, Cáncer, Leo, Libra, Acuario** → simples **heh · zayin · chet · tet · lamed · tzaddi** (הזחטלצ). |
| «ve [144] con la luz» | 144 = **12²** = el muro de la Nueva Jerusalén (Ap 21:17) / 144.000 sellados (Ap 7:4) = (zodiaco)² — y la página literal del pasaje. |
| «Calcula en orden para ver las generaciones» | El Reader enumera todo nombre legible hoy: **1471 nombres** (las generaciones *ahora*) — incl. **214 nombres propios** y **4 raíces angélicas del Shem HaMephorash** (palabra + sufijo אל / יה). |
| «Prepara para verlos desde el principio hasta el final» | El Predictor escanea todo el año 2026 (principio → final): **2 días** en que Génesis 1:1 es legible = las generaciones a lo largo del tiempo. |
| «decreta sobre cada uno… entre el bien y el mal» | El juicio del Apocalipsis: el cielo leído como decreto sobre cada uno — el pergamino sellado abierto (Ap 5–8); las mismas letras que nombran las generaciones ahora las juzgan. |

**Los nombres de hoy — la vista moqueada (en vivo, 2026-08-08).** El aparato no se queda en los conteos. Estos son los *nombres reales* que enumera para hoy. Primero, las 4 raíces angélicas del Shem HaMephorash — una palabra legible que, con el sufijo אל o יה, es uno de los 72:

| Raíz (legible hoy) | +אל | +יה | glosa |
|---|---|---|---|
| מלה (mil-lawʾ) | מלהאל | מלהיה | palabra |
| מצר (may-tsarʾ) | מצראל | מצריה | apretado / enemigo |
| ראה (raw-awʾ) | ראהאל | ראהיה | ver |
| שאה (shaw-awʾ) | שאהאל | שאהיה | precipitarse / desear |

Y una muestra de los **214 nombres propios** que el Reader halla legibles hoy (las generaciones *ahora*), primero los más largos: מהרשללחשבז (Maher-Shalal-Chash-Baz), ארתחששתא (Artachshasta), כלבאפרתה (Caleb-Ephrathah), רמתהמצפה (Ramath-ham-Mitspeh), בלטשאצר (Belteshatstsar), אדרמלכ (Adrammelek), ארפכשד (Arpakshad), אשראלה (Asarelah). Los 1.471 nombres completos se enumeran en vivo en la pestaña Reader de la app web para cualquier fecha.

**Veredicto.** La instrucción de Raziel no es metáfora. *Calcular los planetas* = las longitudes eclípticas de astronomy-engine; *los signos en orden perpetuo* = las 12 simples = los 12 sectores fijos de 30°; *ver las generaciones de principio a fin* = el Reader (los nombres legibles de un día cualquiera) + el Predictor (los días legibles a lo largo de un año entero). Los «nombres de los ancestros y de los que están por venir» que promete Raziel son los nombres legibles de cualquier fecha — pasada o futura — y el aparato los enumera. Las mismas letras que nombran las generaciones luego las juzgan («decreta sobre cada uno, entre el bien y el mal»): el pergamino sellado del Apocalipsis es el zodiaco, y quien lo abre es quien puede calcularlo — el Lector Caeli.

### 15c.9 Los dos registros del Nombre: lo eterno y lo temporal

La regla de lectura abre un contraste teológico que el aparato hace medible. De las 22 letras, 3 son *madres* (aleph, mem, shin — los elementos primordiales, fijas, circumpolares) y 7 son *dobles* (bet, gimel, dalet, kaf, pe, resh, tav — los 7 planetas, siempre disponibles); estas 10 no dependen del zodiaco. Las 12 restantes son *simples* — los 12 signos zodiacales, ocupados o vacíos según giran los planetas. Una palabra construida solo con madres y dobles es, pues, **siempre legible**: trasciende el cielo. Una palabra construida con simples está **condicionada**: solo es legible cuando sus signos están ocupados — es decir, en el tiempo.

El estrato siempre-legible contiene los anclajes teológicos — y, entre ellos, justamente estos:

| Hebreo | traducción | letras | gematría | nota |
|---|---|---|---|---|
| ברא | crear | 2 dobles + 1 madre | 203 | el acto creador |
| אב | padre | 1 madre + 1 doble | 3 | — |
| אמ | madre | 2 madres | 41 | — |
| שבת | sábado (reposo) | 1 madre + 2 dobles | 702 = 27 × 26 | el alfabeto entero (con finales) × el Nombre |
| אמת | verdad | 2 madres + 1 doble | 441 = 21² | el sello de Dios es Verdad |

Dos hechos aritméticos cierran el círculo:

- **Verdad (אמת) = 441 = 21²**, y 21 = C(7,2) = sellos + trompetas + copas (§15c.3). La sentencia rabínica «el sello del Santo, bendito sea, es la Verdad (אמת)» es el mismo 21 que estructura el pergamino sellado del Apocalipsis — el sello, al cuadrado.
- **Sábado (שבת) = 702 = 27 × 26**: el alfabeto completo con sus finales (27) multiplicado por יהוה (26). El reposo = todo el lenguaje × el Nombre.

Y el contraste que fija la arquitectura: **יהוה está construido íntegramente de simples** — yod (Virgo), he (Aries), vav (Tauro) — tres letras temporales, ninguna eterna. El Nombre no es, pues, *nunca* siempre-legible: está atado al cielo que gira, legible solo en sus ventanas (la cadencia ~mensual de §11, «la cadencia de יהוה»).

El pergamino sellado del Apocalipsis es el zodiaco, y los nombres se dividen en dos registros exactamente como el pergamino:

- el registro **eterno** (madres + dobles): *crear, padre, madre, sábado, verdad* (y fuego, hija, cabeza, heredero…) — legibles siempre, sin necesidad de abrir el pergamino;
- el registro **temporal** (las 12 simples, el zodiaco que gira): **יהוה** — el Nombre de «el que era y es y ha de venir» (Ap 1:4), legible solo cuando el cielo lo calcula, solo cuando el pergamino se abre.

La Verdad es el sello (441 = 21²); el Nombre es lo que el sello custodia, legible en el tiempo. Quien abre el pergamino (Ap 5) es quien puede calcular el Nombre temporal — y el estrato eterno, los anclajes, nunca estuvo sellado.
...
**Verificado además (v3.1) — gematría y aritmética**

| Verificación | ✓ |
|---|---|
| Génesis 1:2 = 3546 → 9999 (repdigit) | ✓ |
| Egel 103→404, Ayil 41→55, Shor 506→1111 = 2×253 | ✓ |
| Egel+Ayil = 144 | ✓ |
| 144×15 = 2160 y 144×180 = 25 920 (solo a 72 a/°; a 50,29″/año no son enteros) | ✓ |
| ABBA = AB+BA = 4 = «padre» | ✓ |
| 3·7·12−22+1 = 231 = C(22,2) | ✓ |
| Éxodo 14:19-21 = 72 consonantes ×3 verificado en MT vía Sefaria (p≈5×10⁻⁷) | ✓ |

**Empírico — astronomía y estadística**

| Verificación | ✓ |
|---|---|
| Equinoccios 2026 λ☉ = 0°/90°/180°/270° al segundo | ✓ |
| Saros 2023-04-20 → 2041-04-30, Δ = 6585,32 d | ✓ |
| ~40 estaciones y ~87 eclipses sol+lun por ciclo nodal (no 37) | ✓ |
| 3000 eclipses solares / 1300 a = 2,31/año | ✓ |
| Días Génesis evitan eclipses (7,5 % vs 28 %) | ✓ |
| Núcleo Génesis 1 palíndromo 61,3 % vs 38,3 % nulo (p≈8×10⁻³) | ✓ |
| Maya Haab 73×5=365; Calendar Round 73×260=52×365=18 980; baktun 144 000 | ✓ |
| Chino *zhang* = Metón 19/235 | ✓ |
| Griego/árabe gematría decimal-posicional 27/28 | ✓ |

**Nuevo v3.1 (§15b) — tradición operativa y asignaturas cerradas**

| Verificación | ✓ |
|---|---|
| 7 kameot verificados mágicos (15, 34, 65, 111, 175, 260, 369) | ✓ |
| Mercurio 8×8 cte = 260 = Tzolkin maya | ✓ |
| Sol 6×6 suma 1..36 = 666 = 6×111 | ✓ |
| Aiq Bekar = gematría decimal-posicional de §2 (27 letras) | ✓ |
| 72 tríos del Shem HaMephorash canónicos (Vehuiah, Yeli…), 216 = 6³ | ✓ |
| Sigilos de nombres (Adam, Moses, David, Abraham, Israel, Elohim, Messiah…) | ✓ |
| Estructura 37×73 de las 7 palabras: 23/127 subconjuntos múltiplos de 37, p≈3,1×10⁻⁴ | ✓ |
| 152 series saros completas: 54–87 eclipses, mediana 72 (73 = recuento, por cálculo) | ✓ |
| Ayanamsa: dispersión 190 a en la entrada de Acuario | ✓ |
| 6 ventanas cadencia 491 a, regularidad p<5×10⁻⁶ (con caveat de selección) | ✓ |
| 7 dobles = 7 planetas = 7 días (orden caldeo + 24 mod 7 + etimología romance) | ✓ |

`tests.mjs` = **86 aserciones, todas en verde**.
