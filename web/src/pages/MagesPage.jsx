// pages/MagesPage.jsx — /mages: an INDEX of the magi lineage Adapa → Aleister Crowley.
...
function MagesPage({ onOpen }) {
  ...
  return <div>
    <h1>Magi — from Adapa to Aleister Crowley</h1>
    ...
    <div className="panel" style={{ padding: 14, marginBottom: 14 }}>
      <Timeline items={MAGES} title="Magi timeline — Adapa to Aleister Crowley" accent="#8a05ff" />
    </div>
