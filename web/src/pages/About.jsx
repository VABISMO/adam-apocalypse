  ...
  return (
    <div className="about-page">
      ...
      <div className="panel" style={{padding:18,marginBottom:14}}>
        ...
        <p>Welcome to <i>The Apocalypse of Adam</i> — and do not worry, there is nothing sinister here. <i>Apocalypse</i> is the word used to reveal the knowledge and science of God. Since the last coming of the Antichrist's followers — Sabbatai Zevi (1626–1676), the false messiah of 1666, and his reincarnation Jacob Frank (1726–1791), who led the Frankist baptisms in 1759 — things have only gone from bad to worse. But do not fear: the days when all religions and dogmas will live together are at hand — and the best of it is, nothing need be done to make it so. They have already done a thorough job of breaking the world, sinking it to ashes in every respect, and preparing our arrival. Greed and unconscious individualism have reached their end; our past spirits, roles, and ideas prepared everything well, so that when the right moment came the religions could be unified, the greedy and warlike kingdoms could be brought down — destroyed by their own pride and greed — and society could organize itself to build a coming era of peace and prosperity.</p>
