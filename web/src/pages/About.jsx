  ...
  return (
    <div className="about-page">
      ...
      <div className="panel" style={{padding:18,marginTop:14}}>
        ...
        <p className="muted">By <b>V. Nos</b> &amp; <b>Julian S.</b> · Source on <a href="https://github.com/VABISMO/adam-apocalypse" target="_blank" rel="noreferrer">GitHub</a> · Paper: <a href="https://adam-apocalypse-paper.onrender.com/" target="_blank" rel="noreferrer">The Reader of the Sky</a>.</p>
