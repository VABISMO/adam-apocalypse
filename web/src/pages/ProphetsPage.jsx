...
function ProphetsPage({ onOpen }) {
  ...
  return <div>
    ...
    <p className="muted">A chronology of prophetic and revelatory figures, from the first human <span className="he">אדם</span> and his son <b>Seth</b> — who, per Josephus, inscribed the astronomical knowledge on two pillars (brick and stone) to outlast the flood — through the biblical prophets, the second-temple and apocalyptic writers, the early-Christian and merkabah-mystical tradition, the <b>Islamic prophets</b> (including Job/Ayyub) and the <b>Sufi mystics</b> (including the Illuminationist Suhrawardi), down to the Sabbatean–Frankist thread whose <b style={{ color: 'var(--gold)' }}>{last.designation || 'final'} figure is {last.name} ({fmtYear(last.y0)}–{fmtYear(last.y1)})</b>. {PROPHETS.length} figures across {span}. Click a card to open its profile — a Wikipedia-sourced biography, an infobox of facts, and a life-and-work summary table.</p>
