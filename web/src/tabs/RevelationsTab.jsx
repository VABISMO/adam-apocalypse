...
function RevelationHebrewTab({date, rows, occ, words, genData, genYear}){
  ...
  return <>
    ...
    <blockquote style={{borderLeft:'3px solid var(--gold)', margin:'8px 0', paddingLeft:14, color:'var(--txt)'}}>
      ...
      <i>Está escrito, quien actúa y crea, proclama las generaciones desde el principio, antes de la creación del universo. Para comprender las acciones de cada hombre en la rectitud y la maldad, decreta sobre cada uno. De acuerdo a las obras, prepara las obras entre el bien y el mal.</i><br/><br/>
      <i>Numera los planetas y los signos del zodíaco, disperso en las horas. Pon de manifiesto entre el bien y el mal. Todo fue creado por Elohim en sabiduría e inteligencia, ante el elevamiento del universo.</i><br/><br/>
      <i>La sabiduría del Señor es el cimiento de la Tierra. Numera los planetas y los signos del zodíaco de cada hombre. El universo fue formado ante ellos. De acuerdo a las obras, el hombre es creado para preparar. Dios no da los planetas y los signos del zodíaco debido al permiso de la maldad o la bondad.”</i>
    </blockquote>
    <div className="muted" style={{marginBottom:6}}><b>English:</b> “Combine the signs and the wheel. Engrave and compute and assign and number. Consider the reckonings of the planets and the signs of the zodiac. Compute the periods and the turning planets. Of those suspended and the signs of the zodiac in their perpetual order, see with the light. Compute in order to see the generations. Prepare to see them from the beginning to the end. It is written: he who acts and creates proclaims the generations from the beginning, before the creation of the universe [Isaiah 41:4]. To understand the actions of each man in righteousness and in wickedness, he decrees upon each one. According to the works, he prepares the works between good and evil. Number the planets and the signs of the zodiac, dispersed in the hours. Make manifest between good and evil. All was created by Elohim in wisdom and in understanding, before the raising-up of the universe. The wisdom of the Lord is the foundation of the earth [Proverbs 3:19]. Number the planets and the signs of the zodiac of each man. The universe was formed before them. According to the works, man is created to prepare. God does not give the planets and the signs of the zodiac by permission of evil or of good.”</div>
